...
public class ColaboradorRepository
{
    ...
    public void Add(Colaborador dado)
    {
        ...
        conexao.Open();
        comando.CommandText = @"
                INSERT INTO tb_colaborador (cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha, admissao, tipo, vinculo)
    ...
    public Colaborador ValidaLogin(Colaborador dado)
    {
        ...
        conexao.Open();
        comando.CommandText = @"
                SELECT id_colaborador, cpf, telefone, nome, nascimento, email, logradouro_id, numero, complemento, senha, admissao, tipo, vinculo 
                FROM tb_colaborador 
