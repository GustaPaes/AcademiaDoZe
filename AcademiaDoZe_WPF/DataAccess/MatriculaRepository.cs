...
public class MatriculaRepository
{
    ...
    public Aluno GetAlunoById(int alunoId)
    {
        ...
        var parametro = comando.CreateParameter(); parametro.ParameterName = "@aluno_id"; parametro.Value = alunoId; comando.Parameters.Add(parametro);
    ...
    public void Add(Matricula dado)
    {
        ...
        var aluno_id = comando.CreateParameter(); aluno_id.ParameterName = "@aluno_id"; aluno_id.Value = dado.AlunoId; comando.Parameters.Add(aluno_id);
        var colaborador_id = comando.CreateParameter(); colaborador_id.ParameterName = "@colaborador_id"; colaborador_id.Value = dado.ColaboradorId; comando.Parameters.Add(colaborador_id);
        var plano = comando.CreateParameter(); plano.ParameterName = "@plano"; plano.Value = (char)dado.Plano; comando.Parameters.Add(plano);
        var data_inicio = comando.CreateParameter(); data_inicio.ParameterName = "@data_inicio"; data_inicio.Value = dado.DataInicio; comando.Parameters.Add(data_inicio);
        var data_fim = comando.CreateParameter(); data_fim.ParameterName = "@data_fim"; data_fim.Value = dado.DataFim; comando.Parameters.Add(data_fim);
        var objetivo = comando.CreateParameter(); objetivo.ParameterName = "@objetivo"; objetivo.Value = dado.Objetivo; comando.Parameters.Add(objetivo);
        var restricao_medica = comando.CreateParameter(); restricao_medica.ParameterName = "@restricao_medica"; restricao_medica.Value = (char)dado.RestricaoMedica; comando.Parameters.Add(restricao_medica);
        var obs_restricao = comando.CreateParameter(); obs_restricao.ParameterName = "@obs_restricao"; obs_restricao.Value = dado.ObsRestricao; comando.Parameters.Add(obs_restricao);
        var laudo_medico = comando.CreateParameter(); laudo_medico.ParameterName = "@laudo_medico"; laudo_medico.Value = dado.LaudoMedico ?? (object)DBNull.Value; comando.Parameters.Add(laudo_medico);
    ...
    public void Update(Matricula dado)
    {
        ...
        var id_matricula = comando.CreateParameter(); id_matricula.ParameterName = "@id_matricula"; id_matricula.Value = dado.Id; comando.Parameters.Add(id_matricula);
        var aluno_id = comando.CreateParameter(); aluno_id.ParameterName = "@aluno_id"; aluno_id.Value = dado.AlunoId; comando.Parameters.Add(aluno_id);
        var colaborador_id = comando.CreateParameter(); colaborador_id.ParameterName = "@colaborador_id"; colaborador_id.Value = dado.ColaboradorId; comando.Parameters.Add(colaborador_id);
        var plano = comando.CreateParameter(); plano.ParameterName = "@plano"; plano.Value = (char)dado.Plano; comando.Parameters.Add(plano);
        var data_inicio = comando.CreateParameter(); data_inicio.ParameterName = "@data_inicio"; data_inicio.Value = dado.DataInicio; comando.Parameters.Add(data_inicio);
